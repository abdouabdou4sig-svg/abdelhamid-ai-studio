      ...
      default: return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-12 animate-fade-in">
          <div className="relative">
            <div className="absolute -inset-8 bg-red-600/20 blur-3xl rounded-full animate-pulse"></div>
          ...
          <div className="flex gap-4">
             <button onClick={() => setCurrentTool(ToolType.REMIX_IMAGE)} className="bg-red-600 hover:bg-red-500 text-white px-10 py-5 rounded-3xl font-black uppercase text-sm shadow-2xl transition-all hover:scale-105 active:scale-95">Commencer la création</button>
