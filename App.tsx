      ...
      default: return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center space-y-16 animate-fade-in relative px-6">
          ...
          <div className="pt-24 opacity-20">
             <div className="flex justify-center gap-12 text-[#D4AF37]">
                <div className="flex flex-col items-center">
                   <div className="h-12 w-[1px] bg-current mb-4"></div>
                   <span className="text-[10px] font-magic tracking-widest uppercase">Pureté</span>
                </div>
                <div className="flex flex-col items-center">
                   <div className="h-12 w-[1px] bg-current mb-4"></div>
                   <span className="text-[10px] font-magic tracking-widest uppercase">Vision</span>
                </div>
                <div className="flex flex-col items-center">
                   <div className="h-12 w-[1px] bg-current mb-4"></div>
                   <span className="text-[10px] font-magic tracking-widest uppercase">Pouvoir</span>
                </div>
             </div>
          </div>
        </div>
