      ...
      default: return (
        <div className="flex flex-col items-center justify-center min-h-[75vh] text-center space-y-16 animate-fade-in relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[600px] pointer-events-none opacity-20">
            <div className="absolute inset-0 bg-brand-purple blur-[120px] rounded-full animate-pulse-slow"></div>
            <div className="absolute inset-10 bg-brand-gold blur-[100px] rounded-full animate-float"></div>
          </div>

          <div className="relative space-y-8">
            <h1 className="relative text-7xl md:text-[10rem] font-black uppercase tracking-tighter text-white font-magic leading-none">
              Abdelhamid <br/><span className="text-brand-gold">AI Alchemy</span>
            </h1>
          ...
          <p className="text-xl md:text-2xl text-slate-400 font-medium max-w-4xl leading-relaxed mx-auto px-6">
            L'alliance sacrée de l'algorithme et de l'imaginaire. <br/>Propulsé par les moteurs d'invocation <span className="text-brand-gold font-magic">Gemini 3 Pro</span> & <span className="text-brand-purple font-magic">VEO 3.1</span>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
             ...
             >
               <span className="font-magic">Entrer dans le Studio</span>
             ...
             >
               <span className="opacity-70 group-hover:opacity-100 transition-opacity font-magic">Parler à l'Oracle</span>
             </button>
          </div>
          
          {/* Quick Stats / Ornaments */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-20 max-w-5xl w-full mx-auto opacity-40">
            {[
              { label: "Résolution", val: "8K Native" },
              { id: 2, label: "Vitesse", val: "Sub-Seconde" },
              { id: 3, label: "Moteur", val: "Deep Tensor" },
              { id: 4, label: "Sécurité", val: "End-to-End" }
            ].map(stat => (
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#020205] text-white">
      ...
      <footer className="p-16 border-t border-[#D4AF37]/10 text-center bg-[#050508]">
         <p className="text-[11px] font-black uppercase tracking-[0.6em] text-slate-700">© 2025 Abdelhamid AI Studio Pro • L'Éclat de la Technologie Dorée</p>
