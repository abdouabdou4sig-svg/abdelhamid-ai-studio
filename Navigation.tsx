      ...
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col text-left">
            <h1 className="text-xl font-black text-white tracking-tighter uppercase leading-none font-magic">Abdelhamid</h1>
            <span className="text-[10px] text-[#D4AF37] font-bold tracking-[0.4em] uppercase mt-1">AI Studio Pro</span>
          </div>
        </button>
