...
const Navigation: React.FC<NavigationProps> = ({ currentTool, onSelectTool }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[100] bg-[#020205]/90 backdrop-blur-2xl border-b border-[#D4AF37]/20 shadow-2xl px-6 py-4">
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="bg-[#D4AF37] p-2 rounded-2xl shadow-lg shadow-[#D4AF37]/20 group-hover:scale-110 transition-transform duration-500">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-[10px] text-[#D4AF37] font-bold tracking-[0.4em] uppercase mt-1">Studio Alchimie</span>
          </div>
        </button>
